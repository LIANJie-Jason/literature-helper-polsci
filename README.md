...
- Despite all the guardrails, I suggest you debug the final reports one to two times manually on both the accurate **citations** and the correct **summarizations**. 
